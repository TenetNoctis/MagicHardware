...
class MagicFirebaseAuthException implements Exception {
  /// The error code associated with the exception.
  final String code;

  /// Creates a [MagicFirebaseAuthException] with the given error [code].
  MagicFirebaseAuthException(this.code);
