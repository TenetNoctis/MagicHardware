...
/// A controller for managing the checkout process.
class CheckoutController extends GetxController {
  /// A static getter for the instance of [CheckoutController].
  ...
  void onInit() {
    selectedPaymentMethod.value = PaymentMethodModel(
      ...
      image: MagicImages.cashOnDelivery,
    );
    super.onInit();
  }

  /// Displays a bottom sheet for selecting a payment method.
